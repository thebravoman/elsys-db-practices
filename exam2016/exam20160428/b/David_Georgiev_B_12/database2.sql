...
CREATE TABLE `Article_11` (
  ...
  CONSTRAINT `Article_11_ibfk_1` FOREIGN KEY (`category_id`) REFERENCES `Category_part2` (`id`),
...
INSERT INTO `Category_part1` VALUES (1,'0000-00-00'),(2,'0000-00-00'),(3,'0000-00-00'),(4,'0000-00-00'),(5,'0000-00-00');
...
INSERT INTO `Category_part2` VALUES (1,'Dont'),(2,'Dont'),(3,'Dont'),(4,'Dont'),(5,'Dont');
...
-- Dump completed on 2016-04-28 11:05:09
