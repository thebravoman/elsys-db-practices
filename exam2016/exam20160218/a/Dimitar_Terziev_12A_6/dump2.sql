...
CREATE TABLE `Article_4` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `Article_4_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `User` (`id`)
...
CREATE TABLE `Category_part1` (
  ...
  CONSTRAINT `Category_part1_ibfk_1` FOREIGN KEY (`tag_id`) REFERENCES `Tag` (`id`),
  CONSTRAINT `Category_part1_ibfk_2` FOREIGN KEY (`article_4_id`) REFERENCES `Article_4` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Category_part1` VALUES (1,1,2,'cat1'),(2,2,1,'cat2');
...
CREATE TABLE `Category_part2` (
  ...
  KEY `tag_id` (`tag_id`),
  KEY `article_4_id` (`article_4_id`),
  CONSTRAINT `Category_part2_ibfk_1` FOREIGN KEY (`tag_id`) REFERENCES `Tag` (`id`),
  CONSTRAINT `Category_part2_ibfk_2` FOREIGN KEY (`article_4_id`) REFERENCES `Article_4` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Category_part2` VALUES (1,1,2,1),(2,2,1,2);
...
INSERT INTO `Tag` VALUES (1,'desc1',1),(2,'desc2',5);
...
INSERT INTO `User` VALUES (1,'2016-02-18','pass1','pesho'),(2,'2016-02-18','pass2','tosho');
...
-- Dump completed on 2016-02-18 11:54:58
