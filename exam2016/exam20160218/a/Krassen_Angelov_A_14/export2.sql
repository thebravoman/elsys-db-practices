...
--
-- Структура на таблица `category_part1`
--
...
--
-- Схема на данните от таблица `category_part1`
--
...
--
-- Структура на таблица `category_part2`
--
...
--
-- Схема на данните от таблица `category_part2`
--

INSERT INTO `category_part2` (`id`, `date_created_on`, `article_13_id`) VALUES
(1, '2016-02-01', 1),
(2, '2016-02-02', 2);
...
--
-- Indexes for table `category_part1`
--
ALTER TABLE `category_part1`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `category_part2`
--
...
--
-- AUTO_INCREMENT for table `category_part1`
--
ALTER TABLE `category_part1`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `category_part2`
--
ALTER TABLE `category_part2`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
