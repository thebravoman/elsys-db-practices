...
--
-- Table structure for table `Article_16`
--

DROP TABLE IF EXISTS `Article_16`;
...
CREATE TABLE `Article_16` (
  ...
  PRIMARY KEY (`id`),
  KEY `tag_id` (`tag_id`),
  CONSTRAINT `Article_16_ibfk_1` FOREIGN KEY (`tag_id`) REFERENCES `Tag` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `Article_16`
--

LOCK TABLES `Article_16` WRITE;
/*!40000 ALTER TABLE `Article_16` DISABLE KEYS */;
INSERT INTO `Article_16` VALUES (1,73,'LEVSKI I TECHNO','LEVSKI I TECHNO',1),(2,92,'LEVSKI I TECHNO','LEVSKI I TECHNO',2),(3,70,'LEVSKI I TECHNO','LEVSKI I TECHNO',3),(4,71,'LEVSKI I TECHNO','LEVSKI I TECHNO',4),(5,92,'LEVSKI I TECHNO','LEVSKI I TECHNO',5);
/*!40000 ALTER TABLE `Article_16` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `User_Article_16` (
  ...
  KEY `user_id` (`user_id`),
  CONSTRAINT `User_Article_16_ibfk_1` FOREIGN KEY (`article_16_id`) REFERENCES `Article_16` (`id`),
...
-- Dump completed on 2016-02-18  8:19:04
