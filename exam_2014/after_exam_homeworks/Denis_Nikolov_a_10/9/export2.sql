...
SET DEFINE OFF;
Insert into ELSYS.TAG_PART2 (ID,PRIORITY,SECOND_PRIORITY,ARTICLE_ID) values (1,11,11,1);
Insert into ELSYS.TAG_PART2 (ID,PRIORITY,SECOND_PRIORITY,ARTICLE_ID) values (2,22,22,2);
