...
SET DEFINE OFF;
Insert into ELSYS.ARTICLE (ID,PUBLISHED_ON,CREATED_ON,USER_ID,TAG_ID,NAME) values (2,to_date('2012-01-01','RRRR-MM-DD'),to_date('2012-01-01','RRRR-MM-DD'),1,2,'aasd');
Insert into ELSYS.ARTICLE (ID,PUBLISHED_ON,CREATED_ON,USER_ID,TAG_ID,NAME) values (1,to_date('2012-01-01','RRRR-MM-DD'),to_date('2012-01-01','RRRR-MM-DD'),1,1,'qwqwq');
