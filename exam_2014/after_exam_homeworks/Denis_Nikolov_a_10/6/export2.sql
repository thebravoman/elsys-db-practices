...
--------------------------------------------------------
  DROP TABLE "ELSYS"."ARTICLE_PART1" cascade constraints;
  DROP TABLE "ELSYS"."ARTICLE_PART2" cascade constraints;
...
---------------------------------------------------
--   DATA FOR TABLE ARTICLE_PART1
--   FILTER = none used
---------------------------------------------------
REM INSERTING into ELSYS.ARTICLE_PART1

---------------------------------------------------
--   END DATA FOR TABLE ARTICLE_PART1
---------------------------------------------------


---------------------------------------------------
--   DATA FOR TABLE ARTICLE_PART2
--   FILTER = none used
---------------------------------------------------
REM INSERTING into ELSYS.ARTICLE_PART2
Insert into ELSYS.ARTICLE_PART2 (ID,PUBLISHED_ON,URL,CATEGORY_ID) values (1,to_timestamp('12-APR-01 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'),'a',1);
Insert into ELSYS.ARTICLE_PART2 (ID,PUBLISHED_ON,URL,CATEGORY_ID) values (2,to_timestamp('12-APR-01 12.00.00.000000000 AM','DD-MON-RR HH.MI.SS.FF AM'),'s',1);

---------------------------------------------------
--   END DATA FOR TABLE ARTICLE_PART2
---------------------------------------------------
