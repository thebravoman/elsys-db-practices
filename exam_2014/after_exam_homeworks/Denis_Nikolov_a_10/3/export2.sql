--------------------------------------------------------
--  File created - Вторник-Април-15-2014   
--------------------------------------------------------
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into ELSYS.USERS_PART1 (NAME) values ('qw');
Insert into ELSYS.USERS_PART1 (NAME) values ('as');
REM INSERTING into ELSYS.USERS_PART2
SET DEFINE OFF;
Insert into ELSYS.USERS_PART2 (ID,CATEGORY_ID,PICTURE_URL,PASSWORD,TAG_ID) values (1,1,'ascasc','ascas',1);
Insert into ELSYS.USERS_PART2 (ID,CATEGORY_ID,PICTURE_URL,PASSWORD,TAG_ID) values (2,2,'as a as',' asc',1);
