...
REM INSERTING into ELSYS.CATEGORIES
SET DEFINE OFF;
Insert into ELSYS.CATEGORIES (ID,DESCRIPTION,DATE_CREATED) values (1,'df',to_date('2013-02-01','RRRR-MM-DD'));
Insert into ELSYS.CATEGORIES (ID,DESCRIPTION,DATE_CREATED) values (2,'fdg',to_date('2011-02-02','RRRR-MM-DD'));
